...
8. Untuk login `admin` kalian bisa menggunakan username = `admin01` dan password `admin`
9. Untuk login `kasir` kalian bisa menggunakan username = `KSR50` dan password `kasir`
